...
public class MainActivity extends AppCompatActivity
    ...
    private void parseReceiptsForBillAmounts() {
    ...
    private void adjustBillsForSingleReceipt(Receipt receipt) {
    ...
    private void adjustCreatorAssigneeBillByAmount(String creatorId, String assignee, float itemTotalCost) {
        adjustUserBillByAmount(creatorId, assignee, -1*itemTotalCost);
        adjustUserBillByAmount(assignee, creatorId, itemTotalCost);
    }

    private void adjustUserBillByAmount(final String userId, final String billTargetUserId, final float itemTotalCost) {
    ...
    private void saveTargetUserDetails(final String userId, final String billTargetUserId, final float itemTotalCost, final String billKey) {
